...
public :	
    EndDevices(){
        ...
        cout<<" Device Id : "<<deviceInfo.deviceId<<" deviceName : "<<deviceInfo.displayName<<"\n";
        endDeviceId++;
    }
	...
	void setInfo(){
        ...
        cout<<"Assigning the ip address \n";
            
            
        cout<<" Enter the Ip address : ";
        cin>>deviceInfo.Ip;
        cout<<" Ip address allocated is: "<<deviceInfo.Ip<<"\n";
    ...
    void setConnection(int connectDevice,int endDeviceId,int hubDeviceId,int switchDeviceId, int bridgeDeviceId)
    {
        ...
        if(connectDevice<endDeviceId)
            {
                cout<<"\nConnection made Between "<<deviceInfo.displayName<<" and PC"<<connectDevice;
            }
            else if(connectDevice>=100 && connectDevice<hubDeviceId)
            {
                 cout<<"\n Connection made Between "<<deviceInfo.displayName<<" and Hub"<<connectDevice-100;
            }
            else if(connectDevice>=200 && connectDevice<switchDeviceId)
            {
                 cout<<"\n Connection made Between "<<deviceInfo.displayName<<" and Switch"<<connectDevice-200;
            }
            else if(connectDevice>=300 && connectDevice<bridgeDeviceId)
                {
                    cout<<"\n Connection maden Between "<<deviceInfo.displayName<<" and Bridge"<<connectDevice-300;
                }
...
public: 
    ...
    void setConnection(int connectDevice,int endDeviceId,int hubDeviceId,int switchDeviceId, int bridgeDeviceId)
    {
         bool flag = 0;//connection not done
        ...
        if(flag == 0)
        {
            ...
            if(connectDevice<endDeviceId)
            {
                cout<<"\n Connection made Between "<<hubInfo.displayName<<" and PC"<<connectDevice;
            }
            else if(connectDevice>=100 && connectDevice<hubDeviceId)
            {
                 cout<<"\n Connection made Between "<<hubInfo.displayName<<" and Hub"<<connectDevice-100;
            }
            else if(connectDevice>=200 && connectDevice<switchDeviceId)
            {
                 cout<<"\n Connection made Between "<<hubInfo.displayName<<" and Switch"<<connectDevice-200;
            }
            else if(connectDevice>=300 && connectDevice<bridgeDeviceId)
                {
                    cout<<"\n Connection made Between "<<hubInfo.displayName<<" and Bridge"<<connectDevice-300;
                }
    ...
    void setConnection(int connectDevice,int endDeviceId,int hubDeviceId,int switchDeviceId, int bridgeDeviceId)
    {
        ...
        if(bridgeInfo.connectedToDevices.size()<2)
        {
            ...
            if(flag == 0)
            {
                ...
                cout<<"\n Connection made Between "<<bridgeInfo.displayName<<" and PC"<<connectDevice;
                }
                else if(connectDevice>=100 && connectDevice<hubDeviceId)
                {
                    bridgeInfo.connectedToDevices.push_back(connectDevice);
                    cout<<"\n Connection made Between "<<bridgeInfo.displayName<<" and Hub"<<connectDevice-100;
                }
                else if(connectDevice>=200 && connectDevice<switchDeviceId)
                {
                    bridgeInfo.connectedToDevices.push_back(connectDevice);
                    cout<<"\n Connection made Between "<<bridgeInfo.displayName<<" and Switch"<<connectDevice-200;
                }
                else if(connectDevice>=300 && connectDevice<bridgeDeviceId)
                {   bridgeInfo.connectedToDevices.push_back(connectDevice);
                    cout<<"\n Connection made Between "<<bridgeInfo.displayName<<" and Bridge"<<connectDevice-300;
                }
...
public: 
    ...
    void setConnection(int connectDevice,int endDeviceId,int hubDeviceId,int switchDeviceId, int bridgeDeviceId)
    {
        ...
        if(flag == 0)
        {
            ...
            if(connectDevice<endDeviceId)
            {
                cout<<"\n Connection made Between "<<switchInfo.displayName<<" and PC"<<connectDevice;
            }
            else if(connectDevice>=100 && connectDevice<hubDeviceId)
            {
                 cout<<"\n Connection made Between "<<switchInfo.displayName<<" and Hub"<<connectDevice-100;
            }
            else if(connectDevice>=200 && connectDevice<switchDeviceId)
            {
                 cout<<"\n Connection made Between "<<switchInfo.displayName<<" and Switch"<<connectDevice-200;
            }
            else if(connectDevice>=300 && connectDevice<bridgeDeviceId)
                {
                    cout<<"\n Connection made Between "<<switchInfo.displayName<<" and Bridge"<<connectDevice-300;
                }
...
int main()
{
    ...
    while(true)
    {
            ...
            cout<<"\n 1.Enter 1 for pc operations,2 for switch,3 for bridge,4 for hub, 5 to create connection, 6for data transfer,7 for displaying devices,8 to exit\n";
        ...
        if(choice == 1)
        {
            while(true)
            {
                ...
                cout<<"\n pc functions";
				cout<<"\n enter 1 to Add new Device,2 for show info,3 for change device,4 for display all, 5 to exit";
        ...
        else if(choice == 2)
        {
            ...
            while(true)
            {
                cout<<"\n Enter 1 to Add a Switch, 2 for switch info,3 for all switch info,4 to exit \n";
         ...
         else if(choice == 3)
        {
            ...
            while(true)
            {
                cout<<"\n Enter 1 to Add a Bridge,2 for bridge info,3 to display all bridge, 4 to exit\n";
                cout<<" Enter the choice : ";
                cin>>choice;
                if(choice==1)
                {
        ...
        else if(choice == 4)
        {
          cout<<"\n HUB functions\n";
            while(true)
            {
                cout<<"\n Enter 1 to Add new Device,2 for hub inf0,3 for all hub info,4 to exit \n";
        ...
        else if(choice == 5)
        {
         cout<<"\n CREATE CONNECTIONS\n";
            while(true)
            {
                cout<<"\n Enter 1 to Create Connections and 2 to exit\n";
                cout<<" Enter the choice : ";
                cin>>choice;
                if(choice == 1)
                {
                    cout<<" Enter the ist device id : ";
                    cin>>deviceID1;
                    cout<<" Enter the device Id to be connected : ";
                    cin>>deviceID2;
        ...
        else if(choice == 6)
        {
            ...
            while(true)
            {
                cout<<"\n enter 1 to Start Data Transfer,2 to exit \n";
                cout<<" Enter the choice : ";
                cin>>choice;
                if(choice == 1)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                cout<<"\n"<<route.size()<<"\n";
                                cout<<"\nUnable to send message as no direct OR indirect route possible \n";
                            }
                        }
